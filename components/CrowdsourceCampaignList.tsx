...
interface CrowdsourceCampaignListProps {
  campaigns: Campaign[];
  loading: boolean;
...
export default function CrowdsourceCampaignList({ 
  campaigns, 
  loading, 
  onCampaignSelect, 
  onRefresh 
}: CrowdsourceCampaignListProps) {
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900">BNB Crowdfunding Campaigns</h1>
        <button
          onClick={onRefresh}
